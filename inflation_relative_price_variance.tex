...
(inflationary) shocks {[}\citet{lucas1973}; \citet{hercowitz1981};
\citet{cukierman1983}; \citet{barro1976} leading to cross-sectional
price dispersion which results in allocative inefficiencies generating
adverse real effects. While menu cost models predict a linear
relationship, signal extraction models predict nonlinearities along with
monetary search models \citep{head2005} with the latter also arguing
that moderate inflation can increase welfare suggesting the optimal
inflation can be non-zero.
