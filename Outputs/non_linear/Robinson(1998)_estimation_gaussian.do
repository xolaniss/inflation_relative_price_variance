...
npregress kernel lrpd hcpi, kernel(gaussian)
predict m_y, mean
...
foreach x in lrpd1 lrpd2 lrpd3 {
    npregress kernel `x' hcpi, kernel(gaussian)
    predict m_`x', mean
    gen `x'_tilde = `x' - m_`x'
}
...
graph	export	/// 
"C:\Users\5775\OneDrive - TREASURY\Desktop\Price dispersion_inflation\Main folder\Results\Equation_10\full_sample_gaussian_eq10.png", /// 
as(png) name("Graph")	
/////////////////////////////////////////////SUB-SAMPLES//////////////////////////////////////////////////////////////////
...
graph	export	/// 
"C:\Users\5775\OneDrive - TREASURY\Desktop\Price dispersion_inflation\Main folder\Results\Equation_10\Post2017_gaussian_eq10.png", /// 
as(png) name("Graph")
...
graph	export	/// 
"C:\Users\5775\OneDrive - TREASURY\Desktop\Price dispersion_inflation\Main folder\Results\Equation_10\Pre2017_gaussian_eq10.png", /// 
as(png) name("Graph")	
