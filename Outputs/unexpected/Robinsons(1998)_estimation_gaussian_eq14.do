...
npregress kernel lrpd hcpi_u, kernel(gaussian)
predict m_y, mean
...
foreach x in lrpd1 lrpd2 lrpd3 hcpi_f1 hcpi_sd1 {
    npregress kernel `x' hcpi_u, kernel(gaussian)
    predict m_`x', mean
    gen `x'_tilde = `x' - m_`x'
}
...
graph	export	/// 
"C:\Users\5775\OneDrive - TREASURY\Desktop\Price dispersion_inflation\Main folder\Results\Equation_13\full_sample_gaussian_eq14.png", /// 
as(png) name("Graph")
...
graph	export	/// 
"C:\Users\5775\OneDrive - TREASURY\Desktop\Price dispersion_inflation\Main folder\Results\Equation_13\Post2017_gaussian_eq14.png", /// 
as(png) name("Graph")
...
graph	export	/// 
"C:\Users\5775\OneDrive - TREASURY\Desktop\Price dispersion_inflation\Main folder\Results\Equation_13\Pre2017_gaussian_eq14.png", /// 
as(png) name("Graph")
